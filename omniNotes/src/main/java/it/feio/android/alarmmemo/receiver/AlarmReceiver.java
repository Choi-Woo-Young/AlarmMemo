...
import it.feio.android.alarmmemo.SnoozeActivity;
import it.feio.android.alarmmemo.db.DbHelper;
import it.feio.android.alarmmemo.models.Note;
import it.feio.android.alarmmemo.services.NotificationListener;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	private void createNotification(Context mContext, Note note) {
		...
		notificationsHelper.getBuilder()
				.addAction(R.drawable.ic_material_reminder_time_light, TextHelper
