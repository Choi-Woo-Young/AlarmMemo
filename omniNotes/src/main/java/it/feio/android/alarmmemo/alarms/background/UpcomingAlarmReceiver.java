...
package it.feio.android.alarmmemo.alarms.background;
...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        Log.d(TAG, "UpcomingAlarmReceiver onReceive");
        ...
        if (intent.getAction() == null || actionShowSnoozing) {
            ...
            Notification note = new NotificationCompat.Builder(context)
                    ...
                    .addAction(R.drawable.ic_alarm_black_48dp, context.getString(R.string.dismiss_now), piDismiss)
                    .build();
