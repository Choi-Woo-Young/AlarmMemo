...
package it.feio.android.alarmmemo.alarms.ui;
...
import it.feio.android.alarmmemo.alarms.dialogs.AddLabelDialog;
import it.feio.android.alarmmemo.alarms.dialogs.AddLabelDialogController;
import it.feio.android.alarmmemo.alarms.dialogs.TimePickerDialogController;
import it.feio.android.alarmmemo.alarms.list.BaseViewHolder;
import it.feio.android.alarmmemo.alarms.list.OnListItemInteractionListener;
...
public abstract class BaseAlarmViewHolder extends BaseViewHolder<Alarm> {
    ...
    public BaseAlarmViewHolder(ViewGroup parent, @LayoutRes int layoutRes,
        ...
        mDismissNowDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_alarm_black_48dp);
        mCancelSnoozeDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_action_cancel);
...
/*
    private void bindDismissButton(Alarm alarm) {
        ...
        mDismissButton.setCompoundDrawablesRelativeWithIntrinsicBounds(icon, null, null, null); //wychoi
