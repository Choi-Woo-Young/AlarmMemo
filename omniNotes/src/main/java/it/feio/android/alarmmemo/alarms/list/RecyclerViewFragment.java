...
package it.feio.android.alarmmemo.alarms.list;
...
import it.feio.android.alarmmemo.BaseFragment;
import it.feio.android.alarmmemo.R;
import it.feio.android.alarmmemo.data.BaseItemCursor;
import it.feio.android.alarmmemo.data.ObjectWithId;
...
public abstract class RecyclerViewFragment<
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_alarmslist_list, container, false);
        ...
        if (view instanceof RecyclerView ) {
            ...
            recyclerView.setAdapter(new AlarmsListRecyclerViewAdapter(DummyContent.ITEMS, mListener));
        }
        */
