...
import it.feio.android.alarmmemo.alarms.list.ScrollHandler;
import it.feio.android.alarmmemo.alarms.misc.AlarmController;
import it.feio.android.alarmmemo.data.AsyncDatabaseTableUpdateHandler;
...
public final class AsyncAlarmsTableUpdateHandler extends AsyncDatabaseTableUpdateHandler<Alarm, AlarmsTableManager> {
    ...
    protected void onPostAsyncInsert(Long result, Alarm alarm) {
        Log.d(TAG, "[wychoi] 8.AsyncAlarmsTableUpdateHandler > onPostAsyncInsert");
