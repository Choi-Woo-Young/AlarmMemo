...
package it.feio.android.alarmmemo.alarms.ringtone;
...
import it.feio.android.alarmmemo.BaseActivity;
import it.feio.android.alarmmemo.R;
import it.feio.android.alarmmemo.alarms.ringtone.playback.RingtoneService;
import it.feio.android.alarmmemo.utils.ParcelableUtil;
import it.feio.android.alarmmemo.utils.alarms.LocalBroadcastHelper;
...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    //@Nullable
    @BindView(R.id.rington_title)   TextView mHeaderTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ringtone); //wychoi
